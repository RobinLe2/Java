...
3. 생성 방법
    1) java.lang.Exception 클래스를 상속받는 클래스를 만듭니다.
    2) 예외 클래스는 다른 곳으로 전송이 가능한 직렬화(Serializable) 객체이므로 serialVersionUIT 값을 생성하길 권장합니다.
    3) 예외 클래스 이름은 Exception으로 끝나도록합니다.
 */
public class MyException extends Exception {

    @java.io.Serial //----- import를 생략할 수 있습니다.
    private static final long serialVersionUID = 6812135181236L;
