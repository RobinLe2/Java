...
public class PrimitiveEx {
  ...
  public static void main(String[] args) {
    ...
    {
      // 비트와 바이트
      // 1.비트  : 0 또는 1을 저장할 수 있는 최소 저장단위
      // 2. 바이트 : 8비트로 구성된 메모리의 최소 저장단위
      ...
      // 비트에 따른 데이터 표현 범위 (정수로 국한)
      // 예시)
      // 4비트로 가능한 데이터 범위 : -8 ~ 7
      // 8비트(1바이트) 가능한 데이터 범위   : -128~127
...

    {
      ...
      int c;
      long d;
      a = Byte.MIN_VALUE;     System.out.println(a);
      b=  Short.MIN_VALUE;    System.out.println(b);
      c = Integer.MAX_VALUE;  System.out.println(c);
      d = Long.MAX_VALUE;     System.out.println(d);
      
      // long 타입의 주의점 (int 범위를 벗어나는 값의 리터럴 작성 시 반드시 마지막에 l 또는 L을 추가합니다.)
    ...
    
    {
      ...
      //float 주의사항 (리터럴 작성 시 반드시 마지막에 f또는 F를 추가합니다.)
      a = 1.5f; System.out.println(a); // float은 사용하지 않습니다.
    ...
    
    {
      // char
      // 문자
      // 2바이트 (유니코드 문자 : 0 ~ 65535) 모든 문자
      
      char a = 'a'; System.out.println(a+1);
