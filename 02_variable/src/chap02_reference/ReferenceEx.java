...
public class ReferenceEx {
  ...
  public static void main(String[] args) {
     ...
     * Reference Type
     * 1. 참조 타입입니다.
     * 2. 데이터가 아니라 데이터가 저장된 메모리의 참조값(주소값)
     ...
     *  Java 메모리 구조
     *  
     *  1. 자바 프로그램이 실행되면 JVM(Java  Virtual Machine)이 여러 메모리 영억을 사용합니다.
     *  2. 자바 프로그램을 구성하는 모든 것(변수, 메소드, 클래스 등)들은 메모리에 저장됩니다.
     *  3. 주요 영역
     ...
     *  5. 자바는 실제 참조값(메모리의 주소값)을 직접 확인하거나 수정할 수 있습니다.
     */
