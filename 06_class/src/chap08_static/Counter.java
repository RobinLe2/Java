...
public class Counter {
  ...
  //------- static 메소드 (static 멤버(=클래스 멤버)만 사용할 수 있습니다.)(3번 이전에 다 마무리 되어야한다. 인스턴스를 사용하지 못함)
  public static void viewCount() {
//    System.out.println("현재 Counter 이름: " + name);  인스턴스 멤버 name에는 접근 할 수 없습니다.
    System.out.println("현재 Count: " + count);
  }
  
  //------- 인스턴스 메소드(인스턴스 멤버와 static 멤버 모드 사용할 수 있습니다)
