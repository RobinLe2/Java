 ...
 *     2) protected  : 동일 패키지에 있거나, 상속 관계인 경우
 *     3) default    : 동일 패키지에 있으면 접근할 수 dlT습니다.(default 키워드는 존재하지 않습니다. package 권한이라고도 합니다.Access Modifier 가 없는 경우 default 권한을 가집니다.)
