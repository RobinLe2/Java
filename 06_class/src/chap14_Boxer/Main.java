...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    while (boxer1.getEnergy() > 0 && boxer2.getEnergy () > 0){
      if (boxer1Turn){
        boxer1.punch(boxer2); //boxer1이 boxer 2에게 펀치를 날립니다
      } else {
        boxer2.punch(boxer1);
      }
...
//      boxer2.punch(boxer1);
//      if (boxer1.getEnergy() == 0) {
//        System.out.println(boxer2.getName() + " KO승! 남은 에너지: " + boxer2.getEnergy());
//        break;
//      }
//
//      boxer1.punch(boxer2);
//      if (boxer2.getEnergy() == 0) {
//        System.out.println(boxer1.getName() + " KO승! 남은 에너지: " + boxer1.getEnergy());
//        break;
//      }
//    }
