...
public class Main {
    public static void mathRandom(){
        ...
        System.out.println(Math.random() * 3); // ----- 0.0 <= 난수 < 3
    ...
    public static void secureRandom(){
         ...
         * 3. 암호화 키, 토큰, 세션 ID 등 보안이 필요한 값에는 SecureRandom 사용이 권장됩니다.
         */
    ...
    public static void uuid(){
         ...
         * java.util.UUID
         *
         * 1. 범용 고유 식별자(Universial Unique Identifier)를 생성하고 다루기 위한 클래스입니다.
         * 2. 128비트(16 바이트) 크기의 고유한 값을 생성합니다.
         * 3. 32자리 16진수와 4개의 하이픈(-)으로 구성된 문자열을 생성합니다.
         *    (8-4-4-4-12)
         * 4. 전 세계적으로 중복 값을 생성할 확률이 극히 낮아 충돌 위험이 거의 없습니다.
        ...
        System.out.println(randomText.replace("-",""));  // 모든 하이픈(-) 제거
