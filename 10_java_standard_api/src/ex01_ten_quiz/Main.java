...
public class Main {
    ...
    public static void method1() {
        ...
        String newFileName = uuid + "_" + timestamp + extend;
    ...
    public static void method4() {
        ...
        int count = 0;
        while (balance > 0) {
            int randomPrice = (int) (Math.random() * balance) + 1;
            count++;
            System.out.println("출금 전" + balance + "원, " + count + "회 출금액" + randomPrice + "원, 출금 후" + (balance - randomPrice));
            balance -= randomPrice;
        }
    ...
    public static void method5() {
        ...
        while (true) {
            int jump = (int) (Math.random() * 5) + 1;
            sb.append("\"").append(yuts[jump]).append("\" ");
            if (jump < 4) {
                move += jump;
                break;
            } else {
        ...
        System.out.println(sb + ", " + move + "칸 이동한다.");
    }
    ...
    public static void method6() {
        ...
        System.out.println("생성된" + length + "자리 인증번호는 " + sb + "입니다.");
    ...
    public static void method7() {
        ...
        int privateNumber = 0;
        while (number != privateNumber){

            System.out.print("입력 >>> ");
            privateNumber = guessNumber.nextInt();

        if( privateNumber > number ){
            System.out.println("Down!");
            count ++;
        } else if (privateNumber < number) {
