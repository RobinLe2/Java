package chap01_string.b_stringbulider.instance_array;
...
public class Customer {
    ...
    public String purchase() {
        ...
        for (int i = 0; i < count; i++) {  //--------- 구매한 Product 개수만큼 반복
            ...
            receipt.append((String) product.get("name"))  ;  //----------- 구매내역을 영수증에 기록
            receipt.append("......");
            receipt.append(price + "\n");                   //----------- 구매내역을 영수증에 기록
            // 메소드 체이닝 기능 : receipt.append().append().append()
