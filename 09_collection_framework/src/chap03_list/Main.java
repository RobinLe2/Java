...
/**
 * Comparable 인터페이스를 이용한 List 인터페이스
 *
 ...
 *   2) LinkedList  : 연결 리스트. 비연속 공간을 사용하는 리스트. 순회가 느리지만, 추가/삭제가 빠릅니다.
...
public class Main {
    ...
    public static void sort(){
        ...
        // String 리스트 (Comparable 인터페이스의 구현 클래스)
        ...
        //Data 리스트 (일반 클래스) (Comparable 인터페이스의 구현 클래스)
        List<Data> list2 = new ArrayList<Data>();
        list2.add(new Data(30)); list2. add(new Data(10)); list2. add(new Data(20)); list2. add(new Data(50));
        ...
        4. 추상메소드
           ...
           2) 결과가 음수이면  결과가 음수이면 o1이 앞으로, 양수이면 o2이 뒤로 갑니다.
         */
        ...
        Collections.sort(team, new Comparator<Person>() {
            ...
            public int compare(Person o1, Person o2) {
               // 나이순으로 정렬해 보자.
                return o1.getAge() - o2.getAge(); // 결과가 음수이면 o1이 앞으로, 양수이면 o2이 뒤로 갑니다.
            }
        });
        ...
        Collections.sort(team, new Comparator<Person>() {
            ...
            public int compare(Person o1, Person o2) {
                // 이름순으로 정렬해보자.
                // String은  Comparable 인터페이스의 구현체므로 compareTo() 메소드를 사용할 수 있습니다.
