 ...
 * Wrapper Class
 *
 * 1. 기본 타입(Primitive Type) 데이터를 참조 타입(Reference Type)으로 다뤄야할 때 사용하는 클래스
 ...
 * 5. JDK 1.5 이상에서는 컴파일러가 자동으로 박싱/언박싱을 지원합니다. (Auto Boxing / Auto UnBoxing)
 */
public class Main {
    public static void main(String[] args) {
        //---- Wrapper Class를 객체 이용한 기본 타입 값 저장하기(Auto Boxing)
    Byte a = 1;
    Short b = 2;
    Integer c = 3;
    Long d = 4L;
