...
public class Main {
        ...
        public static void insert () throws Exception{
            ...
            //--- 쿼리문 실행 (DML은 excuteUpdate() 메소드를 호출합니다.)
            int count = ps.executeUpdate(); //------ 성공한 행(Row)의 개수를 반환합니다. (성공 시 1 반환 , 실패시 0 반환)
        ...
        public static void update () throws Exception{
            ...
            //--- tbl_board 테이블에 저장할 값 입력받기
            Scanner sc = new Scanner(System.in);
            System.out.print("수정할 게시글 번호(bid) 입력 >>> "); int bid = sc.nextInt(); sc.nextLine();
            ...
            ps.setInt(3, bid); // WHERE bid = ?에 바인딩
        ...
        public static void delete () throws Exception{
            ...
            // 해당 행 삭제하기
            Scanner sc = new Scanner(System.in);
            System.out.print("삭제할게시글 번호(bid) 입력 >>> "); int bid = sc.nextInt();
            //--- DB 접속
            Connection con = DBConnection.getConnection();
            //--- 쿼리문
